...
public class Esercizio4 {
    ...
    /*
    Date tre stringhe s1, s2 e s3 in input, stampare s3 dopo aver rimpiazzato, all’interno di s3, ogni occorrenza compresa
    tra due spazi di s1 con s2. Ad esempio, date in input le stringhe «Marco», «Java», «boh MarcozioMarco asroma»,
    stampare a video «boh JavazioJava asroma».
